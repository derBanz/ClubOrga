...
public class ContactCoreDtoMapper extends BaseDtoMapper {
  ...
  private void mapPropertiesToBto(ContactDto dto, ContactBto bto) {
  ...
  private void mapPropertiesToDto(ContactBto bto, ContactDto dto) {
  ...
  public void mapToBto(ContactDto dto, ContactBto bto) {
    if (dto != null) {
  ...
  public ContactBto toBto(ContactDto dto) {
    ContactBto bto = new ContactBto();
    mapToBto(dto, bto);
    return bto;
  }

  public void mapToDto(ContactBto bto, ContactDto dto) {
    if (bto != null) {
